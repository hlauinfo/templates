    ...
    quote : {
        ...
        '<div class="quote_container" style="<%= background %>">',
          '<div class="quote_container_inner">',
            '<img class="photoSlide" src="<%= imageUrl %>" />',
              '<aside class="attribution">',
                '<a href="http://twitter.com/<%= username %>" target="_blank" class="avatar">',
                  '<img src="<%= thumbnail %>" /></a><p class="<%= name %>"><%= text %><br />',
                  '<span>Photo by <a href="<%= permalink %>" target="_blank"><%= username %></a></span>',
                '</a>',
              '</aside>',
          '</div>',
        '</div>',
      ...
      twitter : _.template([elementStart,
        '<div class="quote_container" style="<%= background %>">',
          '<div class="quote_container_inner">',
            '<div class="quote">',
              '<p><%= text %><span class="arrow"></span></p>',
              '<aside>',
