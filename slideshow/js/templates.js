;(function() {
  ...
  Templates = {
      ...
      '<img class="photoSlide" src="<%= imgUrl %>" />',
        '<aside class="attribution">',
          '<p class="<%= srcName %>">',
            '<i></i>',
            '<%= caption %><br />',
            '<span>Photo by <a href="<%= permalink %>" target="_blank"><%= attrName %></a></span>',
          '</p>',
        '</aside>',
      elementEnd].join('')),
        ...
        '<div class="quote_container twitter-image" style="<%= background %>">',
          '<div class="quote_container_inner">',
            '<img class="photoSlide" src="<%= imageUrl %>" />',
              '<aside class="attribution">',
                '<div class="user-block"><a href="http://twitter.com/<%= username %>" target="_blank" class="avatar">',
                  '<img src="<%= thumbnail %>" /></a>',
                  '<span class="full-name"><%= name %></span>',
                  '<span><a href="http://twitter.com/<%= username %>" target="_blank" class="handle">@<%= username %></a></span>',
                '</a></div>',
                '<div class="content"><%= text %>',
                '<p class="meta"><a href="<%= permalink %>" target="_blank"><%= timestamp %></a></p>',
              '</div></aside>',
          '</div>',
        '</div>',
        elementEnd].join('')),
          ...
          '<div class="quote_container_inner">',
            '<div class="quote">',
              ...
              '<div class="date_actions">',
                  ...
                  '</div>',
                  '<div class="actions">',
                    '<a href="http://twitter.com/intent/tweet?in_reply_to=<%= tweet_id %>&related=<%= username %>" class="reply" target="_blank">',
                      '<i></i><span>Reply</span>',
                    '</a>',
                    '<a href="http://twitter.com/intent/retweet?tweet_id=<%= tweet_id %>&related=<%= username %>" class="retweet" target="_blank">',
                      '<i></i><span>Retweet</span>',
                    '</a>',
                    '<a href="http://twitter.com/intent/favorite?tweet_id=<%= tweet_id %>&related=<%= username %>" class="favorite" target="_blank">',
    ...
    title : _.template([
      '<div>',
        '<div class="user">',
          '<a class="avatar" href="http://storify.com/<%= story.author.username %>" target="_blank"><img src="<%= story.author.avatar %>" /></a>',
