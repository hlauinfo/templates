            ...
            '<img class="photoSlide" src="<%= imageUrl %>" />',
              '<aside class="attribution">',
                '<div class="user-block">',
                  '<a href="//twitter.com/<%= username %>" target="_blank" class="avatar">',
                    '<img src="<%= thumbnail %>" />',
                  '</a>',
                  '<span class="full-name"><a href="//twitter.com/<%= username %>" target="_blank" class="handle"><%= name %></a></span>',
                  '<span><a href="//twitter.com/<%= username %>" target="_blank" class="handle">@<%= username %></a></span>',
                '</a></div>',
                '<div class="content"><%= text %>',
                '<div class="meta">',
                  '<a href="http://twitter.com/" target="_blank" class="twitter-logo"></a>',
                  '<a href="<%= permalink %>" target="_blank"><%= timestamp %></a>',
                  '<div class="actions">',
          ...
          '<div class="quote_container_inner">',
            '<div class="quote">',
              '<aside>',
                ...
                '</div>',
                '<div class="username_container">',
                  '<div class="name"><a href="//twitter.com/<%= username %>" target="_blank"><%= name %></a></div>',
                  '<div class="username">',
